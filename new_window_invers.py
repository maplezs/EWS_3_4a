...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_5.setTitle(QCoreApplication.translate("MainWindow", u"Save Load Data", None))
    ...
    def openFile(self, MainWindow):
        ...
        if file_name:
            with open(file_name, "r") as f:
                ...
                [x.setText(str(format(float(value), '.5f'))) for x, value in zip(self.list_x, saved_data.get("trajectory").get("x"))]
                [y.setText(str(format(float(value), '.5f'))) for y, value in zip(self.list_y, saved_data.get("trajectory").get("y"))]
                [z.setText(str(format(float(value), '.5f'))) for z, value in zip(self.list_z, saved_data.get("trajectory").get("z"))]
                [gain.setText(' '.join(str(x) for x in value)) for gain, value in zip(self.list_gain, saved_data.get("matrixGain"))]
